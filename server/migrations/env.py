...
config.set_section_option(section, "DB_HOST", database_config.db_host)
config.set_section_option(section, "DB_NAME", database_config.db_name)
config.set_section_option(section, "DB_PORT", database_config.db_port)
...
target_metadata = database.models.base.Base.metadata
